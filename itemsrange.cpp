...
ItemsRange::ItemsRange(QObject *parent,int first,int visibleFirst,int count,
    ...
    QObject(parent)
{
    //qDebug()<<"B first:"<<first<<" visibleFirst:"<<visibleFirst<<" count:"<<count<<" pageItemNum:"<<pageItemNum<<" total:"<<total;
    //确保所有数据不为负数
    ...
    //qDebug()<<"E first:"<<first<<" visibleFirst:"<<visibleFirst<<" count:"<<count<<" pageItemNum:"<<pageItemNum<<" total:"<<total;
}
